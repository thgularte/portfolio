...
export const experiencesItems = [
  ...
  {
    logoCard: "icons/icon_briefcase.svg",
    titleCard: "Experiência autônoma - Criador de site Hostinger",
    subTitleCard: "Vip Veículos",
    descriptionCard: "Desenvolvi em conjunto com um colega um site para a loja Vip Veiculos, que trabalha com venda automóveis, com intuito de divulgar a loja e os veículos disponíveis. Realizo atualizações nos veículos disponíveis e na inserção dos novos. Desenvolvi o site em conjunto com o Sílvio Quintana, utilizando o criador de sites da Hostinger.",
    statusIcon: "icons/icon_calendar.svg",
    additional: "Entrega no ano de 2024"
  }
];