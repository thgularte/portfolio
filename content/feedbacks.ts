...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    id: 2,
    quote:
      "Trabalhar com Theo foi muito bom. Foi um período de muita parceria, troca de ideias e aprendizado. Sempre esteve disposto a colaborar e contribuir da melhor forma possível, tornando o ambiente mais agradável e produtivo. Com certeza fez a diferença no dia a dia e deixou uma experiência muito positiva para todos que trabalharam ao seu lado.",
    name: "Eduarda Amaral",
    role: "Desenvolvedora",
  },
  {
